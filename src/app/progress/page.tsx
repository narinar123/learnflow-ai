...
export const metadata: Metadata = {
  title: 'Progress',
  description: 'Track your learning milestones and skill improvements.',
};
      ...
      <div className="animate-fade-in space-y-6">
        <div>
          ...
          <p className="mt-2 text-[var(--text-secondary)]">
            Track your learning milestones and skill improvements.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-20 px-4 text-center rounded-2xl border border-[var(--border-color)] bg-[var(--bg-surface-2)]">
          ...
          <p className="max-w-md text-[var(--text-secondary)]">
            We are working hard to bring you the Progress experience. Check back soon for updates!
          </p>
        </div>
      </div>
    </AppLayout>
