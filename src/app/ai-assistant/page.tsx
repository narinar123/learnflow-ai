...
export const metadata: Metadata = {
  title: 'AI Tutor',
  description: 'Chat with your personalized AI tutor for 1-on-1 guidance.',
};
      ...
      <div className="animate-fade-in space-y-6">
        <div>
          ...
          <p className="mt-2 text-[var(--text-secondary)]">
            Chat with your personalized AI tutor for 1-on-1 guidance.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-20 px-4 text-center rounded-2xl border border-[var(--border-color)] bg-[var(--bg-surface-2)]">
          ...
          <p className="max-w-md text-[var(--text-secondary)]">
            We are working hard to bring you the AI Tutor experience. Check back soon for updates!
          </p>
        </div>
      </div>
    </AppLayout>
